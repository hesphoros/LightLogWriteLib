 ...
 *****************************************************************************/
#ifndef LIGHT_LOG_WRITE_IMPL_HPP
#define LIGHT_LOG_WRITE_IMPL_HPP
...
// TODO: use iconv for character encoding conversion
// #include <iconv.h> // Uncomment if you want to use iconv for character encoding conversion
...
public:
	 ...
	 * @version 1.0.0
	 */
	LightLogWrite_Impl(size_t maxQueueSize = 500000, LogQueueFullStrategy strategy = LogQueueFullStrategy::Block, size_t reportInterval = 100)
...
private:
	...
	std::queue<LightLogWrite_Info>  pLogWriteQueue;            /*!< Log write queue FIFO             */
	...
	LogQueueFullStrategy            queueFullStrategy;         /*!< Queue full strategy              */
...
#endif // LIGHT_LOG_WRITE_IMPL_HPP
	   // End of LightLogWriteImpl.hpp